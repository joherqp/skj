...
// Visit/Kunjungan Types
export interface Kunjungan {
  id: string;
  userId: string;
  pelangganId?: string;
  namaPelanggan?: string; // For new or manual input
  tipe: 'lama' | 'baru';
  tanggal: Date;
  lokasi?: Lokasi;
  keterangan?: string;
...
export interface RiwayatPelanggan {
  ...
  userId: string;
  tanggal: Date;
  aksi: 'edit' | 'aktifkan' | 'nonaktifkan' | 'buat';
  keterangan?: string;
  dataSebelumnya?: Record<string, unknown>;
...
export interface DatabaseContextType {
  ...
  absensi: Absensi[];
  kunjungan: Kunjungan[];
  riwayatPelanggan: RiwayatPelanggan[];
