        ...
        <View className="flex-1 bg-white">
            ...
            >
                <View style={{ backgroundColor: '#fff', borderRadius: 16, padding: 14, borderWidth: 1, borderColor: '#f4f4f5', marginBottom: 16 }}>
                    <Text style={{ fontSize: 10, color: '#a1a1aa', fontWeight: '800', textTransform: 'uppercase', letterSpacing: 1 }}>Total Setoran</Text>
            ...
            <TouchableOpacity
                ...
                onPress={() => router.push('/setoran/tambah' as any)}
            >
